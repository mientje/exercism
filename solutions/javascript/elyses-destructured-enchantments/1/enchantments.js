 ...
 */
export function getFirstCard([first] = deck) {
  return first;
}
 ...
 */
export function getSecondCard([first, second] = deck) {
  return second;
}
 ...
 */
export function swapTwoCards([first, second] = deck) {
  return [second, first];
 ...
 */
export function shiftThreeCardsAround([one, two, three] = deck) {
 ...
 */
export function pickNamedPile({chosen, disregarded} = piles) {
 ...
 */
export function swapNamedPile({ chosen : disregarded, disregarded : chosen } = piles) {
